...
class _TimelineHeader extends StatelessWidget {
  ...
  final WidgetBuilder seasonBuilder;
            ...
            child: KazumiDesktopPageFrame(
              ...
              child: Row(
                ...
                children: [
                  ...
                  EmbeddedNativeControlArea(
                    child: _TimelineHeaderChip(
                      icon: Icons.calendar_month_rounded,
                      onTap: onSeasonTap,
                      child: seasonBuilder(context),
                    ),
                  ),
...
class _TimelineDayBar extends StatelessWidget {
  const _TimelineDayBar({
