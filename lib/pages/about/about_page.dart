    ...
    return PopScope(
      ...
      child: Scaffold(
        body: KazumiSettingsPageShell(
          title: '关于',
          subtitle: '查看开源信息、外部链接、缓存、日志和更新偏好。',
            ...
            SettingsSectionCard(
              ...
              tiles: [
                SettingsNavTile(
                  ...
                  onTap: () {
                    launchUrl(
                      Uri.parse(ApiEndpoints.projectUrl),
                ...
                SettingsNavTile(
                  ...
                  onTap: () {
                    launchUrl(
                      Uri.parse(ApiEndpoints.sourceUrl),
                      mode: LaunchMode.externalApplication,
                    );
                  },
                ),
                SettingsNavTile(
                  ...
                  onTap: () {
                    launchUrl(
                      Uri.parse(ApiEndpoints.iconUrl),
                      mode: LaunchMode.externalApplication,
                    );
                  },
                ),
                SettingsNavTile(
                  ...
                  onTap: () {
                    launchUrl(
                      Uri.parse(ApiEndpoints.bangumiIndex),
                      mode: LaunchMode.externalApplication,
                    );
                  },
                ),
                ...
                SettingsNavTile(
                  ...
                  onTap: () {
                    launchUrl(
                      Uri.parse(ApiEndpoints.dandanIndex),
                      mode: LaunchMode.externalApplication,
                    );
                  },
                ),
